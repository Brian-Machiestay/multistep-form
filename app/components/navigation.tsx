...
export default function Navigation({ step } : {step: number}) {
      ...
      return (
      <div className="md:min-h-full lg:pt-8 md:bg-[url('/bg-sidebar-desktop.svg')] w-full md:rounded-lg md:items-start md:w-[35%] md:flex-col md:justify-start md:p-8 gap-8 bg-[url('/bg-sidebar-mobile.svg')] bg-cover bg-center bg-no-repeat min-h-40 flex justify-center items-center gap-5">
